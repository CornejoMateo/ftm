        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">
              Year-over-Year Trend - {report.player_name}
            </CardTitle>
          </CardHeader>
          <CardContent>
                ...
                {years.map((y, idx) => {
                  ...
                  return (
                    <TableRow key={y.year}>
                      ...
                      <TableCell>
                        <Badge
                          variant={y.goals > 0 ? "default" : "secondary"}
                        >
                          {y.goals}
                        </Badge>
                      </TableCell>
                      <TableCell>
                        <Badge
                          variant={y.assists > 0 ? "default" : "secondary"}
                        >
                          {y.assists}
                        </Badge>
                      </TableCell>
